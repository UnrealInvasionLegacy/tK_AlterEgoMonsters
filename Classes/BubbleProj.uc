class BubbleProj extends SkaarjProjectile;
...
defaultproperties
{
     ...
     MyDamageType=Class'tk_AlterEgoMonsters.DamTypeBubble'
     ...
     LifeSpan=10.000000
     Texture=Texture'tk_AlterEgoMonsters.Little.AeBubbleProj'
     DrawScale=0.200000
     Skins(0)=Texture'tk_AlterEgoMonsters.Little.AeBubbleProj'
     AmbientGlow=96
