class AlterEgoExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=232))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=40
         StartLocationOffset=(Z=-64.000000)
         MeshSpawningStaticMesh=StaticMesh'tk_AlterEgoMonsters.Complex.ExplosionRing'
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=179,R=51,A=190))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=60
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=64.000000,Max=128.000000)
         MeshSpawningStaticMesh=StaticMesh'tk_AlterEgoMonsters.Simple.ParticleSphere3'
         MeshScaleRange=(Z=(Min=2.000000,Max=2.000000))
         RevolutionsPerSecondRange=(Z=(Min=-0.200000,Max=0.200000))
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=168,G=51))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter3'

     Begin Object Class=MeshEmitter Name=MeshEmitter0
         StaticMesh=StaticMesh'tk_AlterEgoMonsters.Complex.ExplosionRing'
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=158,G=137,R=146))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=7,G=177,R=135))
         ColorScale(3)=(RelativeTime=1.000000)
         ...
         Texture=Texture'tk_AlterEgoMonsters.WarLord.AlterEgoGradient'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=1.000000,Max=1.000000)
         InitialDelayRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(4)=MeshEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.MeshEmitter0'

     Begin Object Class=MeshEmitter Name=MeshEmitter1
         StaticMesh=StaticMesh'tk_AlterEgoMonsters.Complex.ExplosionSphere'
         RenderTwoSided=True
         UseParticleColor=True
         UseColorScale=True
         FadeOut=True
     ...
     End Object
     Emitters(5)=MeshEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=220,G=30,R=5))
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=64,G=174,R=255))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=74,G=223,R=34))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=2
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=111,G=121,R=102))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=55,G=151))
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         RespawnDeadParticles=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(G=255,R=51))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=32,R=49))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'tk_AlterEgoMonsters.AlterEgoExplosion.MeshEmitter2'
